...
import { CallError, runPlugin, type Channel, type Definition } from "../../../packages/plugin-kit/src/index.ts";
...
export const definition: Definition = {
  ...
  selfCheck() {
    ...
    const cases: Array<[Record<string, unknown>, string | undefined, Settings]> = [
      [{}, undefined, { port: 5173, host: "127.0.0.1", dev: true, open: false }],
      [{}, "production", { port: 5173, host: "127.0.0.1", dev: false, open: false }],
      [{ dev: true }, "production", { port: 5173, host: "127.0.0.1", dev: true, open: false }],
      [{ port: 0 }, undefined, { port: 0, host: "127.0.0.1", dev: true, open: false }],
      [{ port: "abc" }, undefined, { port: 5173, host: "127.0.0.1", dev: true, open: false }],
      [{ port: 70000 }, undefined, { port: 5173, host: "127.0.0.1", dev: true, open: false }],
      [{ host: " ", port: 8080 }, undefined, { port: 8080, host: "127.0.0.1", dev: true, open: false }],
      [{ host: "0.0.0.0" }, undefined, { port: 5173, host: "0.0.0.0", dev: true, open: false }],
      [{ open: true }, undefined, { port: 5173, host: "127.0.0.1", dev: true, open: true }],
    ];
